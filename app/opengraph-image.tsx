...
export const alt = "Mid-Atlantic CRE Intelligence — Commercial real estate, explained locally";
  ...
  return new ImageResponse(
    <div style={{ background: "#071a2c", color: "#f5f1e8", display: "flex", flexDirection: "column", height: "100%", justifyContent: "space-between", padding: "64px 72px", position: "relative", width: "100%" }}>
      ...
      <div style={{ alignItems: "center", display: "flex", fontFamily: "Arial, sans-serif", fontSize: 20, fontWeight: 700, justifyContent: "space-between", letterSpacing: 3, position: "relative", textTransform: "uppercase" }}>
        <span>Mid-Atlantic CRE Intelligence</span><span style={{ color: "#c96743", fontFamily: "monospace", fontSize: 16 }}>MD / DC / VA</span>
      </div>
      <div style={{ display: "flex", flexDirection: "column", position: "relative" }}>
        <div style={{ color: "#c96743", fontFamily: "Arial, sans-serif", fontSize: 17, fontWeight: 700, letterSpacing: 4, marginBottom: 24, textTransform: "uppercase" }}>Independent regional research</div>
        <div style={{ display: "flex", flexDirection: "column", fontFamily: "Georgia, serif", fontSize: 76, letterSpacing: -4, lineHeight: 0.92, maxWidth: 880 }}><span>Commercial real estate,</span><span style={{ color: "#aeb9bf", fontStyle: "italic", marginTop: 10 }}>explained locally.</span></div>
      </div>
      <div style={{ alignItems: "center", borderTop: "1px solid rgba(255,255,255,.16)", display: "flex", fontFamily: "Arial, sans-serif", fontSize: 15, justifyContent: "space-between", letterSpacing: 2, paddingTop: 24, position: "relative", textTransform: "uppercase" }}>
        <span style={{ color: "rgba(255,255,255,.62)" }}>Transactions · evidence · market context</span><span style={{ color: "#c96743" }}>2026 research edition</span>
      </div>
    </div>,
    size,
  );
