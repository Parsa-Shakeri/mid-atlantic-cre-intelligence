      ...
      <Container className="grid items-start gap-14 py-14 lg:grid-cols-[minmax(0,780px)_270px] lg:justify-between lg:py-20">
        <div className="min-w-0">
          ...
          <section className="mt-16 scroll-mt-44 border-t-2 border-navy pt-8" id="sources">
            ...
            <Link className="print-hidden mt-6 inline-flex items-center gap-2 text-xs font-semibold text-navy underline decoration-line underline-offset-4" href="/corrections">See a discrepancy? Request an evidence review <ArrowUpRight aria-hidden="true" className="size-3.5 text-accent" /></Link>
          </section>
